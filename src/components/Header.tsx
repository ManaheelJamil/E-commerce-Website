        ...
        <>
            <div className='main-div grid tablet:grid-cols-2 grid-cols-1 mobile:ml-10 tablet:mx-28 mobile:mt-5 tablet:mt-14  m-auto '>
                <div className="left-side mt-16">
                    ...
                    <button className='bg-gray-950 text-white font-semibold tablet:justify-evenly justify-center flex  py-2 mt-8 tablet:w-72 mobile:w-36 px-4'><AiOutlineShoppingCart className=' mobile:text-5xl tablet:text-3xl mr-3 tablet:mt-3'/> <Link href="#" className='text-2xl mt-2'>Start Shopping</Link></button>
                </div>
